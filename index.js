import{a as $}from"./assets/vendor-CLb_lYsF.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function s(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(n){if(n.ep)return;n.ep=!0;const r=s(n);fetch(n.href,r)}})();function k(){const e=document.createElement("div");e.classList.add("artist-loader"),e.innerHTML=`
  ...
  `,e.setAttribute("data-loader",""),document.body.appendChild(e)}function u(){const e=document.querySelector("[data-loader]");e&&e.remove()}const M="https://sound-wave.b.goit.study/api",o={backdrop:document.querySelector("[data-artist-modal]"),closeBtn:null,content:null};let v=[];document.addEventListener("DOMContentLoaded",()=>{o.closeBtn=document.querySelector("[data-artist-modal-close]"),o.content=document.querySelector(".artist-modal-content"),o.closeBtn&&o.closeBtn.addEventListener("click",g),o.backdrop&&o.backdrop.addEventListener("click",T)});function _(e){k(),o.backdrop.classList.remove("is-hidden"),document.body.style.overflow="hidden",U(e),document.addEventListener("keydown",L)}function g(){o.backdrop.classList.add("is-hidden"),document.body.style.overflow="",B(),document.removeEventListener("keydown",L),o.content&&(o.content.innerHTML="")}function T(e){e.target===o.backdrop&&g()}function L(e){e.key==="Escape"&&g()}function B(){v.forEach(({element:e,event:t,handler:s})=>{e.removeEventListener(t,s)}),v=[]}async function U(e){try{const s=(await $.get(`${M}/artists/${e}/albums`)).data;N(s),u()}catch(t){console.error("Error fetching artist details:",t),u(),C()}}function Y(e){if(!e)return"Information missing";const t=e.begin,s=e.end;if(!t&&!s)return"Information missing";if(t&&!s)return`${typeof t=="number"?t:new Date(t).getFullYear()}-present`;if(t&&s){const i=typeof t=="number"?t:new Date(t).getFullYear(),n=typeof s=="number"?s:new Date(s).getFullYear();return`${i}-${n}`}return"Information missing"}function H(e){if(!e)return"--";if(typeof e=="string"&&e.includes(":"))return e;const t=typeof e=="string"?parseInt(e,10):e,s=t>1e4?Math.floor(t/1e3):t,i=Math.floor(s/60),n=s%60;return`${i}:${n.toString().padStart(2,"0")}`}function S(e){if(e.youtubeUrl)return e.youtubeUrl;const t=e.artistName||"",s=e.title||e.strTrack||"";return s?`https://www.youtube.com/results?search_query=${encodeURIComponent(`${t} ${s}`.trim())}`:null}function j(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function N(e){const t=e.strArtist||e.name||"Unknown Artist",s=e.strArtistThumb||e.image||"/img/placeholder.jpg",i=e.strCountry||e.country||"Unknown",n=e.strBiographyEN||e.biography||e.bio||"No biography available.";e.strType||e.type;const r=e.strGender||e.gender,a=e.intMembers||e.members,w={begin:e.intBornYear||e.intFormedYear||e.bornYear||null,end:e.intDiedYear||e.endYear||null};let c=[];e.genres&&Array.isArray(e.genres)?c=e.genres:e.strGenre&&(c=[e.strGenre]);const p=e.albumsList||e.albums||[];let y="";a&&a!=="0"&&a>0&&(y=`<div class="artist-info-item">
    ...
    <div class="artist-header">
      ...
      <img src="${s}" alt="${t}" class="artist-image" onerror="this.src='/img/placeholder.jpg'" />
    </div>
  ...
  `;n&&(l+=`
    ...
    `),c&&c.length>0&&(l+=`
      <div class="artist-genres">
        ${c.map(E=>`<span class="genre-tag__modal">${E}</span>`).join("")}
      </div>
    `),p&&p.length>0&&(l+=`
    ...
    `),o.content.innerHTML=l}function D(e){return e.map(t=>{const s=t.title||t.strAlbum||"Unknown Album",i=t.tracks||[];let n="";return i&&i.length>0?n=q(i):n='<p class="no-tracks">No tracks available</p>',`
  ...
  `}const I={artistsList:document.querySelector("#artists-list"),loadMoreBtn:document.querySelector("#load-more")},{artistsList:h,loadMoreBtn:m}=I,x="https://sound-wave.b.goit.study/api/artists";let f=[],d=0;const O=8;async function P(){try{m.style.display="none",k();const t=(await $.get(x,{params:{limit:20}})).data;f=Array.isArray(t)?t:t.results||t.data||t.artists||[],A(),u()}catch(e){console.error(`Error fetching artists: ${e.message}`),u(),F()}}function F(){h.innerHTML='<p style="color: white; text-align: center;">Не вдалося завантажити артистів❗️</p>'}function A(){const e=f.slice(d,d+O);Q(e),d+=e.length,d>=f.length?m.style.display="none":m.style.display="block"}function G(e){return e.genres&&e.genres.length>0?e.genres.map(t=>`<span class="genre-tag">${t}</span>`).join(""):`<span class="genre-tag">${e.strGenre||"Music"}</span>`}function R(e){return e.strBiographyEN||e.bio||"No biography available"}function K(e){return e._id||e.idArtist}function Q(e){const t=e.map(s=>`
      <li class="artist-card" data-id="${K(s)}">
        <img src="${s.strArtistThumb}" alt="${s.strArtist}" class="artist-card__photo" loading="lazy">
        <div class="artist-card__genres">${G(s)}</div>
        <h3 class="artist-card__name">${s.strArtist}</h3>
        <p class="artist-card__bio">${R(s)}</p>
    ...
    `).join("");h.insertAdjacentHTML("beforeend",t)}m.addEventListener("click",A);h.addEventListener("click",e=>{if(e.target.closest(".js-learn-more")){const s=e.target.closest(".artist-card");_(s.dataset.id)}});P();
