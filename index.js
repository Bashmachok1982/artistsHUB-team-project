import{a as v}from"./assets/vendor-CLb_lYsF.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function s(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(n){if(n.ep)return;n.ep=!0;const r=s(n);fetch(n.href,r)}})();function $(){const e=document.createElement("div");e.classList.add("artist-loader"),e.innerHTML=`
  ...
  `}const I={artistsList:document.querySelector("#artists-list"),loadMoreBtn:document.querySelector("#load-more")},{artistsList:g,loadMoreBtn:k}=I,x="https://sound-wave.b.goit.study/api/artists";let p=[],d=0;const O=8;async function P(){try{$();const t=(await v.get(x)).data;p=Array.isArray(t)?t:t.results||t.data||t.artists||[],A(),u()}catch(e){console.error(`Error fetching artists: ${e.message}`),u(),F()}}function F(){g.innerHTML='<p style="color: white; text-align: center;">Не вдалося завантажити артистів❗️</p>'}function A(){const e=p.slice(d,d+O);Q(e),d+=e.length,d>=p.length&&(k.style.display="none")}function G(e){return e.genres&&e.genres.length>0?e.genres.map(t=>`<span class="genre-tag">${t}</span>`).join(""):`<span class="genre-tag">${e.strGenre||"Music"}</span>`}function R(e){return e.strBiographyEN||e.bio||"No biography available"}function K(e){return e._id||e.idArtist}function Q(e){const t=e.map(s=>`
    ...
    `).join("");g.insertAdjacentHTML("beforeend",t)}k.addEventListener("click",A);g.addEventListener("click",e=>{if(e.target.closest(".js-learn-more")){const s=e.target.closest(".artist-card");_(s.dataset.id)}});P();
